...
export class HomePage {
  ...
  constructor( public nativeStorage:NativeStorage,public navParams: NavParams,public http:Http , private toast: Toast, private databaseprovider: DatabaseProvider, private sqlite: SQLite,private platform: Platform, public navCtrl: NavController) {
